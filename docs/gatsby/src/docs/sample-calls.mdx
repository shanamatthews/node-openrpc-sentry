...
# Query & Transact Advanced Query preview sample API calls (CURL)

### getbalances <a name="getBalancesERC20">USDC & DAI (ERC-20)</a>

Retrieve balances for USDC and DAI. Note that this example shows how Advanced Query APIs normalize input and accept long, mixed-case address.
...
Retrieve balances for USDC. Note that this example shows how Advanced Query APIs normalize input and accept long, mixed-case address.
